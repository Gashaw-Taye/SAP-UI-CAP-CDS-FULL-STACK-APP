sap.ui.define([
...
], function ( Device, Controller, JSONModel, Popover, Button, mobileLibrary,MessageBox,MessageToast,ColumnListItem,Input) {
	"use strict";

	var CController = Controller.extend("miniproject.controller.Masterpage", {
		onInit : function() {
    ...
    // }
			...
			this.oModel.loadData(sap.ui.require.toUrl("miniproject/model/model.json"), null, false);
    ...
    onSave: function(){
      ...
      confirm: function(oEvent) {
        ...
        MessageBox.show(
            "Do you want to delete this recored?.", {
